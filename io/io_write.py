...
with open("/home/centos/IdeaProjects/mp-basics/cities.txt", "w") as city_file:
    for city in cities:
        print(city, file=city_file, flush=True)   # flush - data are written immediately

new_cities = []
with open("/home/centos/IdeaProjects/mp-basics/cities.txt", "r") as city_file:
    for city in cities:
...
with open("/home/centos/IdeaProjects/mp-basics/artist.txt", "w") as artist_file:
    print(artist_data, file=artist_file)


with open("/home/centos/IdeaProjects/mp-basics/artist.txt", "r") as artist_file:
